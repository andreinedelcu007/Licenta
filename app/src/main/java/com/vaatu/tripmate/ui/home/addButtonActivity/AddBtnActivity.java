...
public class AddBtnActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    private void setUpAutoComplete() {
        ...
        //initializeaza gragmentele de cautare
        ...
        //seteaza listener pentru cautare, in cazul in care cautarea s-a realizat cu succes ia adresa respectiva, daca nu logheaza o eraore
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.add_trip_btn:
                ...
                //aici interam prin lista de edittexte (textinputlayout) ca sa luam notitele si sa le bagam in notesList
                ...
                //seteaza erori pentru cand numele, data sau ora sunt necompletate
                if (tripNameTextField.getEditText().getText().toString().equals("")) {
                    ...
                    //daca toate campurile de mai sus indeplinesc conditiile (adica sunt completate) le ia valorile si face un nou tripModel pe care il va trimite prin intent activitatii UpCommingTrips
            ...
            case R.id.add_note_btn:
                //cand apasam pe plus genereaza inca o linie unde sa scrie notes
                generateNoteLayout(view);
                break;
            case R.id.dateTextField:
                //porneste fragmentul pentru alegerea datei
                DialogFragment datepicker = new DatePickerFragment();
                datepicker.show(getSupportFragmentManager(), "date");

                break;
            case R.id.timeTextField:
                //porneste fragmentul pentru alegerea orei
    ...
    //metoda apelata de el in spate ca preia datele din calendar si sa le puna intr-o variabil
    @Override
    ...
    //metoda apelata de el in spate pentru a prelua ora si a le pune intr-o variabila
    @Override
    ...
    //initializeaza spinerele cu repetarea calatoriei si one way trip
    //todo de investigat/refactorizat spinerele
    ...
    //genereaza linii noi pentru notite
