...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        //luam din firebase caltoriile din history
        ...
        //recyclerView (e ca un fel de listView mai evoluat)
        RecyclerView rev = root.findViewById(R.id.recycler);
        //initializam adapterul si ii dam lista de tripmodel
        HistoryAdaptor adpater = new HistoryAdaptor(tripDetails, getActivity());

        //optiuni pentru recyclerView
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        rev.setLayoutManager(linearLayoutManager);

        //ii dam recyclerul adapterul nostru
        rev.setAdapter(adpater);

        //facem o interogare la firebase pentru a lua datele intr-un mod asyncron
